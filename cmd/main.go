...
import (
	...
	"github.com/xzzpig/daemon-cronjob/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6a79a521.xzzpig.com",
	...
	if err = (&controller.DaemonCronJobReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("daemon-cronjob-controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DaemonCronJob")
		os.Exit(1)
	}
